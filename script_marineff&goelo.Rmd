...
datameansimi5=datameansimi4 %>% filter(!Compa == "Interbaie 2")

ggplot(datameansimi5, aes(x=Compa, y=BIvalue,fill=Compa))+
  geom_point(aes(x= Compa, y=BIvalue, color=Compa),alpha=.5)+
...
datameanremp5=datameanremp4 %>% filter(!Compa == "Interbaie 2")

ggplot(datameanremp5, aes(x=Compa, y=BIvalue,fill=Compa))+
  geom_point(aes(x= Compa, y=BIvalue, color=Compa),alpha=.5)+
  geom_boxplot(outlier.shape=NA)+
  theme_bw()+
...
datameanrich5=datameanrich4 %>% filter(!Compa == "Interbaie 2")

ggplot(datameanrich5, aes(x=Compa, y=BIvalue,fill=Compa))+
  geom_point(aes(x= Compa, y=BIvalue, color=Compa),alpha=.5)+
  geom_boxplot(outlier.shape=NA)+
  theme_bw()+
...
ggplot(datameansimi4, aes(x=Compa, y=BIvalue,fill=Compa))+
  geom_violin()+
...
ggplot(datameanremp4, aes(x=Compa, y=BIvalue,fill=Compa))+
  geom_violin()+
  geom_boxplot(width=0.2)+
  theme_bw()+
  xlab("Echelle")+ ylab("Remplacement")+
...
ggplot(datameanrich4, aes(x=Compa, y=BIvalue,fill=Compa))+
  geom_violin()+
  geom_boxplot(width=0.2)+
  theme_bw()+
  xlab("Echelle")+ ylab("Richesse")+
