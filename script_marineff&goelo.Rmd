...
datamean<-datatern2 %>%  group_by(Compasite,Compastruct,Comp_date) %>% 
  dplyr::summarize(Similarité=mean(Similarité),
            Remplacement=mean(Remplacement),
            Richesse=mean(Richesse))


datameansimi=datamean %>% select(Compasite,Compastruct,Comp_date,Similarité) %>% 
  mutate(Betaindex= "Similarité") %>% select(Betaindex,Compasite,Compastruct,Comp_date,Similarité)
colnames(datameansimi)[5]<-"BIvalue"

datameanremp=datamean %>% select(Compasite,Compastruct,Comp_date,Remplacement) %>% 
  mutate(Betaindex= "Remplacement") %>% select(Betaindex,Compasite,Compastruct,Comp_date,Remplacement)
colnames(datameanremp)[5]<-"BIvalue"

datameanrich=datamean %>% select(Compasite,Compastruct,Comp_date,Richesse)  %>% 
  mutate(Betaindex= "Richesse") %>% select(Betaindex,Compasite,Compastruct,Comp_date,Richesse)
colnames(datameanrich)[5]<-"BIvalue"
...
# Data similarité
datameansimi$Compabaie<-datameansimi$Compasite

datameansimi$Compabaie<-datameansimi$Compabaie[datameansimi$Compabaie == "Bi/recif1" | datameansimi$Compabaie == "Bi/recif2" | datameansimi$Compabaie == "Bi/recif3" | datameansimi$Compabaie == "Bu/recif1" | datameansimi$Compabaie == "Bu/recif2" | datameansimi$Compabaie == "Bu/recif3" | datameansimi$Compabaie == "Fe/recif1" | datameansimi$Compabaie == "Fe/recif2" | datameansimi$Compabaie == "Fe/recif3" | datameansimi$Compabaie == "VB/recif1" | datameansimi$Compabaie == "VB/recif2" | datameansimi$Compabaie == "VB/recif3"]<-"Inter"

datameansimi$Compabaie<-datameansimi$Compabaie[datameansimi$Compabaie == "Bi/Bi" | datameansimi$Compabaie == "Bu/Bu" | datameansimi$Compabaie == "Fe/Fe" | datameansimi$Compabaie == "VB/VB" | datameansimi$Compabaie == "recif1/recif1" | datameansimi$Compabaie == "recif2/recif2" | datameansimi$Compabaie == "recif3/recif3"]<-"Intra"

datameansimi$Compasite[datameansimi$Compasite == "Bi/Bi"| datameansimi$Compasite == "Bu/Bu"| datameansimi$Compasite == "Fe/Fe"| datameansimi$Compasite == "VB/VB"| datameansimi$Compasite == "recif1/recif1"| datameansimi$Compasite == "recif2/recif2"| datameansimi$Compasite == "recif3/recif3"] <- "Intra"
datameansimi$Compasite[datameansimi$Compasite == "Bu/Bi"| datameansimi$Compasite == "Fe/Bi"| datameansimi$Compasite == "Fe/Bu"| datameansimi$Compasite == "VB/Bi" | datameansimi$Compasite == "VB/Bu" | datameansimi$Compasite == "VB/Fe" | datameansimi$Compasite == "recif2/recif1"| datameansimi$Compasite == "recif3/recif2"| datameansimi$Compasite == "recif3/recif1"] <- "Inter"
...
datameansimi$Compastruct[datameansimi$Compastruct == "Columns/Disc"| datameansimi$Compastruct == "Columns/Iner_slots"| datameansimi$Compastruct == "Disc/Columns"| datameansimi$Compastruct == "Disc/Inner_slots"| datameansimi$Compastruct == "Disc/Pillars"| datameansimi$Compastruct == "Inner_slots/Columns" | datameansimi$Compastruct == "Inner_slots/Disc"| datameansimi$Compastruct == "Inner_slots/Pillars" | datameansimi$Compastruct == "Pillars/Columns"| datameansimi$Compastruct == "Pillars/Disc"| datameansimi$Compastruct == "Pillars/Inner_slots"| datameansimi$Compastruct == "Columns/Inner_slots"| datameansimi$Compastruct == "Columns/Pillars"] <- "Inter"


# Data remplacement
datameanremp$Compabaie<-datameanremp$Compasite

datameanremp$Compabaie<-datameanremp$Compabaie[datameanremp$Compabaie == "Bi/recif1" | datameanremp$Compabaie == "Bi/recif2" | datameanremp$Compabaie == "Bi/recif3" | datameanremp$Compabaie == "Bu/recif1" | datameanremp$Compabaie == "Bu/recif2" | datameanremp$Compabaie == "Bu/recif3" | datameanremp$Compabaie == "Fe/recif1" | datameanremp$Compabaie == "Fe/recif2" | datameanremp$Compabaie == "Fe/recif3" | datameanremp$Compabaie == "VB/recif1" | datameanremp$Compabaie == "VB/recif2" | datameanremp$Compabaie == "VB/recif3"]<-"Inter"

datameanremp$Compabaie<-datameanremp$Compabaie[datameanremp$Compabaie == "Bi/Bi" | datameanremp$Compabaie == "Bu/Bu" | datameanremp$Compabaie == "Fe/Fe" | datameanremp$Compabaie == "VB/VB" | datameanremp$Compabaie == "recif1/recif1" | datameanremp$Compabaie == "recif2/recif2" | datameanremp$Compabaie == "recif3/recif3"]<-"Intra"

datameanremp$Compasite[datameanremp$Compasite == "Bi/Bi"| datameanremp$Compasite == "Bu/Bu"| datameanremp$Compasite == "Fe/Fe"| datameanremp$Compasite == "VB/VB"| datameanremp$Compasite == "recif1/recif1"| datameanremp$Compasite == "recif2/recif2"| datameanremp$Compasite == "recif3/recif3"] <- "Intra"
datameanremp$Compasite[datameanremp$Compasite == "Bu/Bi"| datameanremp$Compasite == "Fe/Bi"| datameanremp$Compasite == "Fe/Bu"| datameanremp$Compasite == "VB/Bi" | datameanremp$Compasite == "VB/Bu" | datameanremp$Compasite == "VB/Fe" | datameanremp$Compasite == "recif2/recif1"| datameanremp$Compasite == "recif3/recif2"| datameanremp$Compasite == "recif3/recif1"] <- "Inter"
...
datameanremp$Compastruct[datameanremp$Compastruct == "Columns/Disc"| datameanremp$Compastruct == "Columns/Iner_slots"| datameanremp$Compastruct == "Disc/Columns"| datameanremp$Compastruct == "Disc/Inner_slots"| datameanremp$Compastruct == "Disc/Pillars"| datameanremp$Compastruct == "Inner_slots/Columns" | datameanremp$Compastruct == "Inner_slots/Disc"| datameanremp$Compastruct == "Inner_slots/Pillars" | datameanremp$Compastruct == "Pillars/Columns"| datameanremp$Compastruct == "Pillars/Disc"| datameanremp$Compastruct == "Pillars/Inner_slots"| datameanremp$Compastruct == "Columns/Inner_slots"| datameanremp$Compastruct == "Columns/Pillars"] <- "Inter"


# Date Richesse
datameanrich$Compabaie<-datameanrich$Compasite

datameanrich$Compabaie<-
datameanrich$Compabaie[datameanrich$Compasite == "Bi/recif1" | datameanrich$Compabaie == "Bi/recif2" | datameanrich$Compabaie == "Bi/recif3" | datameanrich$Compabaie == "Bu/recif1" | datameanrich$Compabaie == "Bu/recif2" | datameanrich$Compabaie == "Bu/recif3" | datameanrich$Compabaie == "Fe/recif1" | datameanrich$Compabaie == "Fe/recif2" | datameanrich$Compabaie == "Fe/recif3" | datameanrich$Compabaie == "VB/recif1" | datameanrich$Compabaie == "VB/recif2" | datameanrich$Compabaie == "recif3/VB"]<-"Inter"

datameanrich$Compabaie<-
datameanrich$Compabaie[datameanrich$Compasite == "Bi/Bi" | datameanrich$Compasite == "Bu/Bu" | datameanrich$Compasite == "Fe/Fe" | datameanrich$Compasite == "VB/VB" | datameanrich$Compasite == "recif1/recif1" | datameanrich$Compasite == "recif2/recif2" | datameanrich$Compasite == "recif3/recif3"]<-"Intra"


datameanrich$Compasite[datameanrich$Compasite == "Bi/Bi"| datameanrich$Compasite == "Bu/Bu"| datameanrich$Compasite == "Fe/Fe"| datameanrich$Compasite == "VB/VB"| datameanrich$Compasite == "recif1/recif1"| datameanrich$Compasite == "recif2/recif2"| datameanrich$Compasite == "recif3/recif3"] <- "Intra"
datameanrich$Compasite[datameanrich$Compasite == "Bu/Bi"| datameanrich$Compasite == "Fe/Bi"| datameanrich$Compasite == "Fe/Bu"| datameanrich$Compasite == "VB/Bi" | datameanrich$Compasite == "VB/Bu" | datameanrich$Compasite == "VB/Fe" | datameanrich$Compasite == "recif2/recif1"| datameanrich$Compasite == "recif3/recif2"| datameanrich$Compasite == "recif3/recif1"] <- "Inter"
...
rf1<-randomForest(BIvalue~.,data=datameansimi[,-c(1)],ntree=200)
rf2<-randomForest(BIvalue~.,data=datameanremp[,-c(1)],ntree=200)
rf3<-randomForest(BIvalue~.,data=datameanrich[,-c(1)],ntree=200)
