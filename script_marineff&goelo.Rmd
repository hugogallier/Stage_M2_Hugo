...
dataR3=dataR3 %>% mutate(Structure = fct_recode(Structure2, Disques = "Disc", Piliers = "Pillars", Colonnes = "Columns", Failles="Inner_slots"))
dataR3=dataR3 %>% mutate(Site = fct_recode(Site, Goëlo1 = "recif1",  Goëlo2 = "recif2",  Goëlo3 = "recif3"))

col1<-c("#ff9900", "#ff99ff", "#339966","#CCFF33","#CCCCCC","#999999","#666666")

ggplot(dataR3, aes(Structure,S2, fill=Site))+ # Avec "fill" ou "col" du peut ajout une séparation de tes données par facteur (ici le site)
  xlab("Structure")+
  ylab("Richesse taxonomique moyenne")+
  geom_point(aes(colour=Site),alpha=.5,position=position_dodge(0.75))+
  scale_color_manual(values = c("#ff6633", "#99CCFF", "#339966","gold1","#CCCCCC","#999999","#666666"))+
  ...
  scale_fill_manual(values = c("#ff6633", "#99CCFF", "#339966","gold1","#CCCCCC","#999999","#666666"))+
  theme_bw()+  
...
ggsave("richesse taxo interbaie.png",width=15,height=8,dpi=350)


adonis2(dataR3$S2~Structure*Site,data=dataR3,permutations=999) #utilisation d'une permanova car anova ne remplit pas les conditions
...
datatern=datatern %>% mutate(Structure1 = fct_recode(Structure1, Disques = "Disc", Piliers = "Pillars", Colonnes = "Columns", Failles="Inner_slots")) %>% mutate(Structure2 = fct_recode(Structure2, Disques = "Disc", Piliers = "Pillars", Colonnes = "Columns", Failles="Inner_slots"))
...
datameansimi$Compa[datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Colonnes/Colonnes" |datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Disques/Disques" |datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Piliers/Piliers" |datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Failles/Failles"]<-"Intersite 2"


# structure
datameansimi$Compa[datameansimi$Compastruct == "Colonnes/Disques" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Colonnes/Failles" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Disques/Colonnes" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Disques/Failles" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Disques/Piliers" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Failles/Colonnes" & datameansimi$Compa =="Intra" | datameansimi$Compastruct == "Failles/Disques" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Failles/Piliers"  & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Colonnes" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Disques" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Failles"  & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Colonnes/Piliers" & datameansimi$Compa =="Intra"] <- "Interstruct"


datameansimi$Compa[datameansimi$Compastruct == "Disques/Disques" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Failles/Failles" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Colonnes/Colonnes" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Piliers" & datameansimi$Compa =="Intra"] <- "Intrastruct"
...
datameansimi$Compa[datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Colonnes/Colonnes" | datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Disques/Disques" | datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Piliers/Piliers"| datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Failles/Failles"]<-"Interbaie 2"
...
datameanremp$Compa[datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Colonnes/Colonnes" |datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Disques/Disques" |datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Piliers/Piliers" |datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Failles/Failles"]<-"Intersite 2"


# structure
datameanremp$Compa[datameanremp$Compastruct == "Colonnes/Disques" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Colonnes/Failles" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Disques/Colonnes" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Disques/Failles" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Disques/Piliers" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Failles/Colonnes" & datameanremp$Compa =="Intra" | datameanremp$Compastruct == "Failles/Disques" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Failles/Piliers"  & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Piliers/Colonnes" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Piliers/Disques" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Piliers/Failles"  & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Colonnes/Piliers" & datameanremp$Compa =="Intra"] <- "Interstruct"


datameanremp$Compa[datameanremp$Compastruct == "Disques/Disques" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Failles/Failles" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Colonnes/Colonnes" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Piliers/Piliers" & datameanremp$Compa =="Intra"] <- "Intrastruct"
...
datameanremp$Compa[datameanremp$Compa=="Interbaie" & datameanremp$Compastruct == "Colonnes/Colonnes" | datameanremp$Compa=="Interbaie" & datameanremp$Compastruct == "Disques/Disques" | datameanremp$Compa=="Interbaie" & datameanremp$Compastruct == "Piliers/Piliers"| datameanremp$Compa=="Interbaie" & datameanremp$Compastruct == "Failles/Failles"]<-"Interbaie 2"
...
datameanrich$Compa[datameanrich$Compa == "Intersite" & datameanrich$Compastruct == "Colonnes/Colonnes" |datameanrich$Compa == "Intersite" & datameanrich$Compastruct == "Disques/Disques" |datameanrich$Compa == "Intersite" & datameanrich$Compastruct == "Piliers/Piliers" |datameanrich$Compa == "Intersite" & datameanrich$Compastruct == "Failles/Failles"]<-"Intersite 2"


# structure
datameanrich$Compa[datameanrich$Compastruct == "Colonnes/Disques" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Colonnes/Failles" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Disques/Colonnes" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Disques/Failles" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Disques/Piliers" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Failles/Colonnes" & datameanrich$Compa =="Intra" | datameanrich$Compastruct == "Failles/Disques" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Failles/Piliers"  & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Piliers/Colonnes" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Piliers/Disques" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Piliers/Failles"  & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Colonnes/Piliers" & datameanrich$Compa =="Intra"] <- "Interstruct"


datameanrich$Compa[datameanrich$Compastruct == "Disques/Disques" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Failles/Failles" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Colonnes/Colonnes" & datameanrich$Compa =="Intra"| datameanrich$Compastruct == "Piliers/Piliers" & datameanrich$Compa =="Intra"] <- "Intrastruct"
...
datameanrich$Compa[datameanrich$Compa=="Interbaie" & datameanrich$Compastruct == "Colonnes/Colonnes" | datameanrich$Compa=="Interbaie" & datameanrich$Compastruct == "Disques/Disques" | datameanrich$Compa=="Interbaie" & datameanrich$Compastruct == "Piliers/Piliers"| datameanrich$Compa=="Interbaie" & datameanrich$Compastruct == "Failles/Failles"]<-"Interbaie 2"
...
datameanremp4<-datameanremp4[which(datameanremp4$Compa!="Intersite" & datameanremp4$Compasite2 !="goelo"),]
datameanrich4<-datameanrich4[which(datameanrich4$Compa!="Intersite" & datameanrich4$Compasite2 !="goelo"),]
...
ggplot(datameansimi4, aes(x=Compa, y=BIvalue))+
  ...
  geom_signif(comparisons=compar,map_signif_level = TRUE,step_increase = 0.05,color="black",textsize = 8,vjust=0.5)+
  theme(axis.text.x = element_text(size=16,colour="black"))+
  theme(axis.text.y = element_text(size=16,colour="black"))+
  theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de similarité")
...
ggplot(datameanremp4, aes(x=Compa, y=BIvalue))+
  ...
  theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de remplacement")
...
ggplot(datameanrich4, aes(x=Compa, y=BIvalue))+
  ...
  theme(legend.position="none")+
  geom_signif(comparisons=compar,map_signif_level = TRUE,step_increase = 0.05,textsize = 8,vjust=0.5)+
  theme(axis.text.x = element_text(size=16,colour="black"))+
  theme(axis.text.y = element_text(size=16,colour="black"))+
    theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de richesse")
...
datameansimi5<-datameansimi5[order(datameansimi5$BIvalue),]
...
ggplot(datameansimi5,aes(x=Compasite2,y=BIvalue))+
  ...
  geom_signif(comparisons=compar1,map_signif_level = TRUE,step_increase = 0.05,textsize = 8,vjust=0.5)+
   theme_bw()+
  theme(axis.text.x = element_text(size=16,colour="black"))+
  theme(axis.text.y = element_text(size=16,colour="black"))+
  theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Comparaisons sites")+ylab("Valeurs de similarité")
...
theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
    xlab("Comparaisons sites")+ylab("Valeurs de remplacement")
...
ggplot(datameanrich5,aes(x=Compasite2,y=BIvalue))+
  ...
  theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
      xlab("Comparaisons sites")+ylab("Valeurs de richesse")
...
compar2<-list(c("Colonnes/Disques","Failles/Colonnes"),c("Piliers/Colonnes","Failles/Colonnes"),c("Colonnes/Disques","Failles/Piliers"),c("Piliers/Disques","Failles/Colonnes"),c("Piliers/Colonnes","Failles/Piliers"),c("Colonnes/Disques","Failles/Disques"),c("Piliers/Disques","Failles/Piliers"),c("Piliers/Colonnes","Failles/Disques"),c("Piliers/Disques","Failles/Disques"))
...
ggplot(datameansimi5,aes(x=Compastruct,y=BIvalue))+
  ...
  geom_signif(comparisons=compar2,map_signif_level = TRUE,step_increase = 0.05,textsize = 8,vjust=0.5)+
  theme_bw()+
...
compar2<-list(c("Failles/Piliers","Failles/Disques"),c("Colonnes/Disques","Failles/Disques"),c("Piliers/Disques","Failles/Disques"),c("Piliers/Colonnes","Failles/Colonnes"),c("Piliers/Colonnes","Failles/Disques"))
...
compar2<-list(c("Failles/Colonnes","Failles/Piliers"),c("Piliers/Disques","Failles/Disques"),c("Piliers/Colonnes","Failles/Piliers"),c("Piliers/Disques","Failles/Colonnes"),c("Colonnes/Disques","Failles/Disques"),c("Piliers/Disques","Failles/Piliers"),c("Colonnes/Disques","Failles/Colonnes"),c("Colonnes/Disques","Failles/Piliers"))
...
datameansimi7=datameansimi6 %>% filter(Compa=="Interbaie 2")
lm1<-lm(BIvalue~Comp_date,data=datameansimi7) #pour voir quelle est la tendance temporelle
summary(lm1)
...
datameanremp7=datameanremp6 %>% filter(Compa=="Intrastruct")
lm1<-lm(BIvalue~Comp_date,data=datameanremp7) #pour voir quelle est la tendance temporelle
summary(lm1)
...
datameanrich7=datameanrich6 %>% filter(Compa=="Interbaie 2")
lm1<-lm(BIvalue~Comp_date,data=datameanrich7) #pour voir quelle est la tendance temporelle
summary(lm1)
...
#test avec geom_rangepoint
databeta1=databeta %>% mutate(Mean1=mean(BIvalue),.by=c(Betaindex,Comp_date2,Compa)) %>% 
  mutate(min1=min(BIvalue),.by=c(Betaindex,Comp_date2,Compa)) %>% 
  mutate(max1=max(BIvalue),.by=c(Betaindex,Comp_date2,Compa)) %>% 
  mutate(sd=sd(BIvalue),.by=c(Betaindex,Comp_date2,Compa))

databeta2=databeta1 %>%  select(Betaindex,Comp_date2,Compa,Mean1,min1,max1,sd)  %>% distinct()

ggplot(databeta2,aes(x=Comp_date2,y=Mean1))+
  geom_pointrange(databeta2,mapping=aes(x=Comp_date2,y=Mean1,ymin=(Mean1-sd),ymax=(Mean1+sd),colour=Betaindex,shape=Betaindex),position=position_dodge(width=0.35),size=0.7)+
    scale_shape_manual(values = c(15,16,17)) +
  stat_summary(mapping=aes(x=Comp_date2,y=Mean1,color=Betaindex,group=Betaindex),fun = 'mean', geom = "line",position = position_dodge(width = .35))+
  facet_wrap(~Compa)+
  scale_x_date(breaks = databeta2$Comp_date2, labels = date_format("%Y-%m"))+
  theme_bw()+
  theme(axis.text.x = element_text(size=14,colour="black",angle=-70,vjust=-0.2))+
  theme(axis.text.y = element_text(size=14,colour="black"))+
   theme(axis.title.x = element_text(size = 14,colour="black"))+
 theme(axis.title.y = element_text(size = 14,colour="black"))+
  theme(strip.text.x = element_text(size = 16,colour="black"))+ xlab("Dates d'échantillonnages")+ylab("Valeurs des composantes de diversité β")
ggsave("betadivechellestemporelles.png",width=15,height=8,dpi=350)
...
lm1<-lm(data=datameanremp6,BIvalue~Comp_date2*Compa)
summary(lm1)
...
datameansimi$Compa[datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Columns/Columns" |datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Disc/Disc" |datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Piliers/Piliers" |datameansimi$Compa == "Intersite" & datameansimi$Compastruct == "Inner_slots/Inner_slots"]<-"Intersite 2"


# structure
datameansimi$Compa[datameansimi$Compastruct == "Columns/Disc" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Columns/Inner_slots" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Disc/Columns" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Disc/Inner_slots" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Disc/Piliers" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Inner_slots/Columns" & datameansimi$Compa =="Intra" | datameansimi$Compastruct == "Inner_slots/Disc" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Inner_slots/Piliers"  & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Columns" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Disc" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Inner_slots"  & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Columns/Piliers" & datameansimi$Compa =="Intra"] <- "Interstruct"


datameansimi$Compa[datameansimi$Compastruct == "Disc/Disc" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Inner_slots/Inner_slots" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Columns/Columns" & datameansimi$Compa =="Intra"| datameansimi$Compastruct == "Piliers/Piliers" & datameansimi$Compa =="Intra"] <- "Intrastruct"

# baie
datameansimi$Compa[datameansimi$Compasite == "Bi/recif1" | datameansimi$Compasite == "Bi/recif2" | datameansimi$Compasite == "Bi/recif3" | datameansimi$Compasite == "Bu/recif1" | datameansimi$Compasite == "Bu/recif2" | datameansimi$Compasite == "Bu/recif3" | datameansimi$Compasite == "Fe/recif1" | datameansimi$Compasite == "Fe/recif2" | datameansimi$Compasite == "Fe/recif3" | datameansimi$Compasite == "VB/recif1" | datameansimi$Compasite == "VB/recif2" | datameansimi$Compasite == "VB/recif3"   | datameansimi$Compasite == "VB/recif3" | datameansimi$Compasite == "VB/recif3"| datameansimi$Compasite == "recif1/Bu" | datameansimi$Compasite == "recif1/Fe" | datameansimi$Compasite == "recif1/Bi" | datameansimi$Compasite == "recif2/Bu" | datameansimi$Compasite == "recif2/Bi" | datameansimi$Compasite == "recif2/Fe" | datameansimi$Compasite == "recif3/Bi" | datameansimi$Compasite == "recif3/Bu" | datameansimi$Compasite == "recif3/Fe"]<-"Interbaie"

datameansimi$Compa[datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Columns/Columns" | datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Disc/Disc" | datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Piliers/Piliers"| datameansimi$Compa=="Interbaie" & datameansimi$Compastruct == "Inner_slots/Inner_slots"]<-"Interbaie 2"
...
datameanremp$Compa[datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Columns/Columns" |datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Disc/Disc" |datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Piliers/Piliers" |datameanremp$Compa == "Intersite" & datameanremp$Compastruct == "Inner_slots/Inner_slots"]<-"Intersite 2"


# structure
datameanremp$Compa[datameanremp$Compastruct == "Columns/Disc" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Columns/Inner_slots" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Disc/Columns" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Disc/Inner_slots" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Disc/Piliers" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Inner_slots/Columns" & datameanremp$Compa =="Intra" | datameanremp$Compastruct == "Inner_slots/Disc" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Inner_slots/Piliers"  & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Piliers/Columns" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Pillars/Disc" & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Pillars/Inner_slots"  & datameanremp$Compa =="Intra"| datameanremp$Compastruct == "Columns/Pillars" & datameanremp$Compa =="Intra"] <- "Interstruct"
...
### Ajout distance entre les sites + plot
```{r}
# Similarité
...
datameanbetadiv2$Betaindex<-fct_relevel(datameanbetadiv2$Betaindex,c("Similarité","Remplacement","Richesse"))
datameanbetadiv2=datameanbetadiv2 %>% filter(!dist %in% c("0.001","0.01"))



datameanbetadiv2$dist=as.numeric(levels(datameanbetadiv2$dist))[datameanbetadiv2$dist]# trasnforme la distance en numérique

ggplot(datameanbetadiv2,mapping=aes(x = dist, y = BIvalue, color=Betaindex ))+
       stat_summary(fun.data = 'mean_sdl', fun.min = 0, geom = "pointrange",position = position_dodge(width = .35))+
  ...
  theme(axis.title.x = element_text(size=16,colour="black"))+
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Distance en kilomètres")+ylab("Valeurs des indices diversité")+
  scale_x_continuous(breaks = seq(0, 70, by = 5))
ggsave("Betadivselondistance.png",width=15,height=9,dpi=350)
...
ggplot(datameanbetadiv2,mapping=aes(x = dist, y = BIvalue, color=Betaindex ))+
  ...
  stat_summary(mapping=aes(x=dist,y=BIvalue,color=Betaindex,group=Betaindex),fun = 'mean', geom = "line",position = position_dodge(width = .35),linewidth=1.5)+
  theme_bw()+
    theme(axis.text.x = element_text(size=16,colour="black"))+
   theme(axis.text.y = element_text(size=16,colour="black"))+
  theme(axis.title.x = element_text(size=16,colour="black"))+
  ...
  xlab("Distance en kilomètres")+ylab("Valeurs des indices diversité")+
  scale_x_continuous(breaks = seq(0, 70, by = 5))
ggsave("Betadivselondistance2.png",width=15,height=9,dpi=350)
...
################################################################################
#### C'est à partir de là que ca commence à ramer quand j'augmente le nombre####
################################################################################
...
################################################################################
##### Et c'est à partir de là que je détermine les différentes comparaisons#####
##### même si je sais que y'a des techniques bien plus simples à utiliser ######
##### et normalelement si tu lances la partie d'en haut ca devrait fonctionner #
################################################################################
...
Boucle pour production du modèle nul pour étudier la Beta-deviation
** Pour 10 communautés générées, chez moi ça ne prend pas plus de 20
secondes.
```{r}
...
# Recuperation des meta data
# Ici j'ai simplement modifié les "Inner_slots" en 'ISlot" pour
# simplifier la séparation # des labels en fin de tache
meta_data<-data_comp2GM %>%droplevels() %>% 
mutate(Structure2=recode_factor(Structure2,'Inner_slots'='ISlot')) %>%
   select(Site,Structure2,Date_courte,saison) %>%
   mutate(Name=paste0(Site,'_',Structure2,'_',Date_courte,'_',saison)) %>%
   select(Name)


# j'ai réalisé une version plus light de ton système de boucle
List_nullmod=list()
List_nullmodsim=list()
List_nullmodremp=list()
List_nullmodrich=list()
for (i in 1:200){

mat_rand<-t(apply(mat,1,sample)) # Selection aléatoire de chaque ligne
colnames(mat_rand)<- colnames(mat)
rownames(mat_rand)<-meta_data$Name
...
databetadiv_rand<-beta.div.comp(mat_rand,coef="S")

mat.D=as.matrix(databetadiv_rand$D)
mat.D[upper.tri(mat.D)]<-NA
diag(mat.D)<-NA
rownames(mat.D)<-meta_data$Name
colnames(mat.D)<-meta_data$Name


mat.repl=as.matrix(databetadiv_rand$repl)
mat.repl[upper.tri(mat.repl)]<-NA
diag(mat.repl)<-NA
rownames(mat.repl)<-meta_data$Name
colnames(mat.repl)<-meta_data$Name


mat.rich=as.matrix(databetadiv_rand$rich)
mat.rich[upper.tri(mat.rich)]<-NA
diag(mat.rich)<-NA
rownames(mat.rich)<-meta_data$Name
colnames(mat.rich)<-meta_data$Name


# # ici je concatène directement les 3 df
# test.mat.D=rbind(na.omit(reshape2::melt(mat.D)) %>% mutate(Type='S'),
#                   na.omit(reshape2::melt(mat.repl)) %>% mutate(Type='Rep'),
#                   na.omit(reshape2::melt(mat.repl)) %>% mutate(Type='Dif'))
# 
# 
# # J'ai modifié les fonction "separate" par "separate_wider_delim", plus
# #rapide
# Null_betadiv=test.mat.D %>%
#    separate_wider_delim(Var1, "_", names=c('Site_1','Strc_1','Date_1','Saison1')) %>%
#    separate_wider_delim(Var2, "_", names=c('Site_2','Strc_2','Date_2','Saison2')) %>%
#      mutate(run=i)


# List_nullmod[[i]]<-Null_betadiv
List_nullmodsim[[i]]<-mat.D
List_nullmodremp[[i]]<-mat.repl
List_nullmodrich[[i]]<-mat.rich

   print(i)

}

sum_matrix_sim <- Reduce("+", List_nullmodsim) #additionner les matrices entre elles
mean_matrix_sim <- sum_matrix_sim / length(List_nullmodsim) #divise les matrices par le nombre de réplicats


sum_matrix_remp <- Reduce("+", List_nullmodremp) #additionner les matrices entre elles
mean_matrix_remp <- sum_matrix_remp / length(List_nullmodremp) #divise les matrices par le nombre de réplicats
sum_matrix_rich <- Reduce("+", List_nullmodrich) #additionner les matrices entre elles
mean_matrix_rich <- sum_matrix_rich / length(List_nullmodrich) #divise les matrices par le nombre de réplicats

 test.mat.simi=rbind(na.omit(reshape2::melt(mean_matrix_sim)) %>% mutate(Type='S'))
 test.mat.remp=rbind(na.omit(reshape2::melt(mean_matrix_remp)) %>% mutate(Type='Rep'))
 test.mat.rich=rbind(na.omit(reshape2::melt(mean_matrix_rich)) %>% mutate(Type='Dif'))

Null_betadivsimi=test.mat.simi %>%
   separate_wider_delim(Var1, "_", names=c('Site_1','Strc_1','Date_1','Saison1')) %>%
   separate_wider_delim(Var2, "_", names=c('Site_2','Strc_2','Date_2','Saison2')) %>%
     mutate(run=i)
Null_betadivsimi$value<-1-Null_betadivsimi$value
Null_betadivremp=test.mat.remp %>%
   separate_wider_delim(Var1, "_", names=c('Site_1','Strc_1','Date_1','Saison1')) %>%
   separate_wider_delim(Var2, "_", names=c('Site_2','Strc_2','Date_2','Saison2')) %>%
     mutate(run=i)
Null_betadivrich=test.mat.rich %>%
   separate_wider_delim(Var1, "_", names=c('Site_1','Strc_1','Date_1','Saison1')) %>%
   separate_wider_delim(Var2, "_", names=c('Site_2','Strc_2','Date_2','Saison2')) %>%
     mutate(run=i)

Null_betadiv<-rbind(Null_betadivsimi,Null_betadivremp,Null_betadivrich)
head(Null_betadiv)
colnames(Null_betadiv)<-c("Site1","Structure1","Date1","Saison1","Site2","Structure2","Date2","Saison2","value","BIindex","run")
datatern=Null_betadiv %>% mutate(Structure1 = fct_recode(Structure1, Disques = "Disc", Piliers = "Pillars", Colonnes = "Columns", Failles="ISlot")) %>% mutate(Structure2 = fct_recode(Structure2, Disques = "Disc", Piliers = "Pillars", Colonnes = "Columns", Failles="ISlot"))
...
datatern2null=datatern2null %>% 
 mutate(Compasite<-paste(Site1,Site2,sep="/")) %>% 
  mutate(Compastruct<-paste(Structure1,Structure2,sep="/")) %>% 
  mutate(Compadate<-paste(Date1,Date2,sep="/")) 
colnames(datatern2null)[15]<-"Compasite"
colnames(datatern2null)[16]<-"Compastruct"
colnames(datatern2null)[17]<-"Compadate"



datameansiminull=datatern2null %>% filter(BIindex == "S")
datameanrempnull=datatern2null %>% filter(BIindex == "Rep")
datameanrichnull=datatern2null %>% filter(BIindex == "Dif")

datameansiminull<-datameansiminull %>%  group_by(Compasite,Compastruct,Comp_date,BIindex) %>% 
  dplyr::summarize(Similarité=mean(value)) 
  colnames(datameansiminull)[5]<-"BIvalue"   
  
datameanrempnull<-datameanrempnull %>%  group_by(Compasite,Compastruct,Comp_date,BIindex) %>% 
  dplyr::summarize(Remplacement=mean(value))           
  colnames(datameanrempnull)[5]<-"BIvalue"             

datameanrichnull<-datameanrichnull %>%  group_by(Compasite,Compastruct,Comp_date,BIindex) %>% 
  dplyr::summarize(Richesse=mean(value))       
  colnames(datameanrichnull)[5]<-"BIvalue"             

databetaindex <- rbind(datameansiminull,datameanrempnull,datameanrichnull)

databetaindex$BIvalue<-as.numeric(databetaindex$BIvalue)
databetaindex$BIindex<-as.factor(databetaindex$BIindex)
databetaindex$Compastruct<-as.factor(databetaindex$Compastruct)
databetaindex$Compasite<-as.factor(databetaindex$Compasite)
databetaindex$Comp_date<-as.factor(databetaindex$Comp_date)
# databetaindex$Comp_day<-as.numeric(databetaindex$Comp_day)
...
# Data similarité
datameansiminull$Compa<-rep(0)

# site
datameansiminull$Compa[datameansiminull$Compasite == "Bu/Bi"| datameansiminull$Compasite == "Fe/Bi"| datameansiminull$Compasite == "Fe/Bu"| datameansiminull$Compasite == "VB/Bi" | datameansiminull$Compasite == "VB/Bu" | datameansiminull$Compasite == "VB/Fe" | datameansiminull$Compasite == "recif1/Bi"| datameansiminull$Compasite == "recif1/Bu" | datameansiminull$Compasite == "recif1/Fe" | datameansiminull$Compasite == "recif1/Bi" | datameansiminull$Compasite == "recif2/Bu" | datameansiminull$Compasite == "recif2/Bi" | datameansiminull$Compasite == "recif2/Fe" | datameansiminull$Compasite == "recif3/Bi" | datameansiminull$Compasite == "recif3/Bu" | datameansiminull$Compasite == "recif3/Fe" | datameansiminull$Compasite == "Bi/recif1" | datameansiminull$Compasite == "Bi/recif2" | datameansiminull$Compasite == "Bi/recif3" | datameansiminull$Compasite == "Bu/recif1" | datameansiminull$Compasite == "Bu/recif2" | datameansiminull$Compasite == "Bu/recif3" | datameansiminull$Compasite == "Fe/recif1" | datameansiminull$Compasite == "Fe/recif2" | datameansiminull$Compasite == "Fe/recif3" | datameansiminull$Compasite == "VB/recif1" | datameansiminull$Compasite == "VB/recif2" | datameansiminull$Compasite == "VB/recif3"   | datameansiminull$Compasite == "VB/recif3" | datameansiminull$Compasite == "VB/recif3" | datameansiminull$Compasite == "recif2/recif1"| datameansiminull$Compasite == "recif3/recif2"| datameansiminull$Compasite == "recif3/recif1"]<-"Intersite"

datameansiminull$Compa[datameansiminull$Compasite == "Bi/Bi"| datameansiminull$Compasite == "Bu/Bu"| datameansiminull$Compasite == "Fe/Fe"| datameansiminull$Compasite == "VB/VB"|datameansiminull$Compasite == "recif1/recif1"|datameansiminull$Compasite == "recif2/recif2"|datameansiminull$Compasite == "recif3/recif3"] <- "Intra"


datameansiminull$Compa[datameansiminull$Compa == "Intersite" & datameansiminull$Compastruct == "Colonnes/Colonnes" |datameansiminull$Compa == "Intersite" & datameansiminull$Compastruct == "Disques/Disques" |datameansiminull$Compa == "Intersite" & datameansiminull$Compastruct == "Piliers/Piliers" |datameansiminull$Compa == "Intersite" & datameansiminull$Compastruct == "Failles/Failles"]<-"Intersite 2"


# structure
datameansiminull$Compa[datameansiminull$Compastruct == "Colonnes/Disques" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Colonnes/Failles" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Disques/Colonnes" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Disques/Failles" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Disques/Piliers" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Failles/Colonnes" & datameansiminull$Compa =="Intra" | datameansiminull$Compastruct == "Failles/Disques" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Failles/Piliers"  & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Piliers/Colonnes" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Piliers/Disques" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Piliers/Failles"  & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Colonnes/Piliers" & datameansiminull$Compa =="Intra"] <- "Interstruct"


datameansiminull$Compa[datameansiminull$Compastruct == "Disques/Disques" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Failles/Failles" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Colonnes/Colonnes" & datameansiminull$Compa =="Intra"| datameansiminull$Compastruct == "Piliers/Piliers" & datameansiminull$Compa =="Intra"] <- "Intrastruct"

# baie
datameansiminull$Compa[datameansiminull$Compasite == "Bi/recif1" | datameansiminull$Compasite == "Bi/recif2" | datameansiminull$Compasite == "Bi/recif3" | datameansiminull$Compasite == "Bu/recif1" | datameansiminull$Compasite == "Bu/recif2" | datameansiminull$Compasite == "Bu/recif3" | datameansiminull$Compasite == "Fe/recif1" | datameansiminull$Compasite == "Fe/recif2" | datameansiminull$Compasite == "Fe/recif3" | datameansiminull$Compasite == "VB/recif1" | datameansiminull$Compasite == "VB/recif2" | datameansiminull$Compasite == "VB/recif3"   | datameansiminull$Compasite == "VB/recif3" | datameansiminull$Compasite == "VB/recif3"| datameansiminull$Compasite == "recif1/Bu" | datameansiminull$Compasite == "recif1/Fe" | datameansiminull$Compasite == "recif1/Bi" | datameansiminull$Compasite == "recif2/Bu" | datameansiminull$Compasite == "recif2/Bi" | datameansiminull$Compasite == "recif2/Fe" | datameansiminull$Compasite == "recif3/Bi" | datameansiminull$Compasite == "recif3/Bu" | datameansiminull$Compasite == "recif3/Fe"]<-"Interbaie"

datameansiminull$Compa[datameansiminull$Compa=="Interbaie" & datameansiminull$Compastruct == "Colonnes/Colonnes" | datameansiminull$Compa=="Interbaie" & datameansiminull$Compastruct == "Disques/Disques" | datameansiminull$Compa=="Interbaie" & datameansiminull$Compastruct == "Piliers/Piliers"| datameansiminull$Compa=="Interbaie" & datameansiminull$Compastruct == "Failles/Failles"]<-"Interbaie 2"

datameansiminull = datameansiminull %>% filter(!Compa == "Intersite") %>% filter(!Compa == "Interbaie")

# datameansiminull$a<-rep(0)
# datameansiminull$a[datameansiminull$Compasite=="recif1/recif2"| datameansiminull$Compasite=="recif1/recif3"  | datameansiminull$Compasite=="recif2/recif3" | datameansiminull$Compasite=="recif3/recif2"| datameansiminull$Compasite=="recif3/recif1"| datameansiminull$Compasite=="recif2/recif1"]<-"ab"

datameansiminull$Compasite2<-datameansiminull$Compasite
datameansiminull$Compasite2[datameansiminull$Compasite=="recif1/recif2"| datameansiminull$Compasite=="recif1/recif3"  | datameansiminull$Compasite=="recif2/recif3" | datameansiminull$Compasite=="recif3/recif2"| datameansiminull$Compasite=="recif3/recif1"| datameansiminull$Compasite=="recif2/recif1"]<-"goelo"


datameansiminull2<-aggregate(BIvalue~BIindex+Compastruct+Comp_date+Compa+Compasite2,data=datameansiminull[datameansiminull$Compasite2=="goelo",],FUN=mean)
datameansiminull3<-aggregate(BIvalue~BIindex+Compastruct+Comp_date+Compa+Compasite2,data=datameansiminull[datameansiminull$Compasite2!="goelo",],FUN=mean)

datameansiminull4<-rbind(datameansiminull2,datameansiminull3)



# Data remplacement
datameanrempnull$Compa<-rep(0)
# site
datameanrempnull$Compa[datameanrempnull$Compasite == "Bu/Bi"| datameanrempnull$Compasite == "Fe/Bi"| datameanrempnull$Compasite == "Fe/Bu"| datameanrempnull$Compasite == "VB/Bi" | datameanrempnull$Compasite == "VB/Bu" | datameanrempnull$Compasite == "VB/Fe" | datameanrempnull$Compasite == "recif1/Bi"| datameanrempnull$Compasite == "recif1/Bu" | datameanrempnull$Compasite == "recif1/Fe" | datameanrempnull$Compasite == "recif1/Bi" | datameanrempnull$Compasite == "recif2/Bu" | datameanrempnull$Compasite == "recif2/Bi" | datameanrempnull$Compasite == "recif2/Fe" | datameanrempnull$Compasite == "recif3/Bi" | datameanrempnull$Compasite == "recif3/Bu" | datameanrempnull$Compasite == "recif3/Fe" | datameanrempnull$Compasite == "Bi/recif1" | datameanrempnull$Compasite == "Bi/recif2" | datameanrempnull$Compasite == "Bi/recif3" | datameanrempnull$Compasite == "Bu/recif1" | datameanrempnull$Compasite == "Bu/recif2" | datameanrempnull$Compasite == "Bu/recif3" | datameanrempnull$Compasite == "Fe/recif1" | datameanrempnull$Compasite == "Fe/recif2" | datameanrempnull$Compasite == "Fe/recif3" | datameanrempnull$Compasite == "VB/recif1" | datameanrempnull$Compasite == "VB/recif2" | datameanrempnull$Compasite == "VB/recif3"   | datameanrempnull$Compasite == "VB/recif3" | datameanrempnull$Compasite == "VB/recif3" | datameanrempnull$Compasite == "recif2/recif1"| datameanrempnull$Compasite == "recif3/recif2"| datameanrempnull$Compasite == "recif3/recif1"]<-"Intersite"

datameanrempnull$Compa[datameanrempnull$Compasite == "Bi/Bi"| datameanrempnull$Compasite == "Bu/Bu"| datameanrempnull$Compasite == "Fe/Fe"| datameanrempnull$Compasite == "VB/VB"|datameanrempnull$Compasite == "recif1/recif1"|datameanrempnull$Compasite == "recif2/recif2"|datameanrempnull$Compasite == "recif3/recif3"] <- "Intra"


datameanrempnull$Compa[datameanrempnull$Compa == "Intersite" & datameanrempnull$Compastruct == "Colonnes/Colonnes" |datameanrempnull$Compa == "Intersite" & datameanrempnull$Compastruct == "Disques/Disques" |datameanrempnull$Compa == "Intersite" & datameanrempnull$Compastruct == "Piliers/Piliers" |datameanrempnull$Compa == "Intersite" & datameanrempnull$Compastruct == "Failles/Failles"]<-"Intersite 2"


# structure
datameanrempnull$Compa[datameanrempnull$Compastruct == "Colonnes/Disques" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Colonnes/Failles" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Disques/Colonnes" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Disques/Failles" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Disques/Piliers" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Failles/Colonnes" & datameanrempnull$Compa =="Intra" | datameanrempnull$Compastruct == "Failles/Disques" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Failles/Piliers"  & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Piliers/Colonnes" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Piliers/Disques" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Piliers/Failles"  & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Colonnes/Piliers" & datameanrempnull$Compa =="Intra"] <- "Interstruct"


datameanrempnull$Compa[datameanrempnull$Compastruct == "Disques/Disques" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Failles/Failles" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Colonnes/Colonnes" & datameanrempnull$Compa =="Intra"| datameanrempnull$Compastruct == "Piliers/Piliers" & datameanrempnull$Compa =="Intra"] <- "Intrastruct"

# baie
datameanrempnull$Compa[datameanrempnull$Compasite == "Bi/recif1" | datameanrempnull$Compasite == "Bi/recif2" | datameanrempnull$Compasite == "Bi/recif3" | datameanrempnull$Compasite == "Bu/recif1" | datameanrempnull$Compasite == "Bu/recif2" | datameanrempnull$Compasite == "Bu/recif3" | datameanrempnull$Compasite == "Fe/recif1" | datameanrempnull$Compasite == "Fe/recif2" | datameanrempnull$Compasite == "Fe/recif3" | datameanrempnull$Compasite == "VB/recif1" | datameanrempnull$Compasite == "VB/recif2" | datameanrempnull$Compasite == "VB/recif3"   | datameanrempnull$Compasite == "VB/recif3" | datameanrempnull$Compasite == "VB/recif3"| datameanrempnull$Compasite == "recif1/Bu" | datameanrempnull$Compasite == "recif1/Fe" | datameanrempnull$Compasite == "recif1/Bi" | datameanrempnull$Compasite == "recif2/Bu" | datameanrempnull$Compasite == "recif2/Bi" | datameanrempnull$Compasite == "recif2/Fe" | datameanrempnull$Compasite == "recif3/Bi" | datameanrempnull$Compasite == "recif3/Bu" | datameanrempnull$Compasite == "recif3/Fe"]<-"Interbaie"

datameanrempnull$Compa[datameanrempnull$Compa=="Interbaie" & datameanrempnull$Compastruct == "Colonnes/Colonnes" | datameanrempnull$Compa=="Interbaie" & datameanrempnull$Compastruct == "Disques/Disques" | datameanrempnull$Compa=="Interbaie" & datameanrempnull$Compastruct == "Piliers/Piliers"| datameanrempnull$Compa=="Interbaie" & datameanrempnull$Compastruct == "Failles/Failles"]<-"Interbaie 2"


datameanrempnull = datameanrempnull %>% filter(!Compa == "Intersite") %>% filter(!Compa == "Interbaie")


datameanrempnull$Compasite2<-datameanrempnull$Compasite
datameanrempnull$Compasite2[datameanrempnull$Compasite=="recif1/recif2"| datameanrempnull$Compasite=="recif1/recif3"  | datameanrempnull$Compasite=="recif2/recif3" | datameanrempnull$Compasite=="recif3/recif2"| datameanrempnull$Compasite=="recif3/recif1"| datameanrempnull$Compasite=="recif2/recif1"]<-"goelo"


datameanrempnull2<-aggregate(BIvalue~BIindex+Compastruct+Comp_date+Compa+Compasite2,data=datameanrempnull[datameanrempnull$Compasite2=="goelo",],FUN=mean)
datameanrempnull3<-aggregate(BIvalue~BIindex+Compastruct+Comp_date+Compa+Compasite2,data=datameanrempnull[datameanrempnull$Compasite2!="goelo",],FUN=mean)

datameanrempnull4<-rbind(datameanrempnull2,datameanrempnull3)




# Date Richesse
datameanrichnull$Compa<-rep(0)

#Site
datameanrichnull$Compa[datameanrichnull$Compasite == "Bu/Bi"| datameanrichnull$Compasite == "Fe/Bi"| datameanrichnull$Compasite == "Fe/Bu"| datameanrichnull$Compasite == "VB/Bi" | datameanrichnull$Compasite == "VB/Bu" | datameanrichnull$Compasite == "VB/Fe" | datameanrichnull$Compasite == "recif1/Bi"| datameanrichnull$Compasite == "recif1/Bu" | datameanrichnull$Compasite == "recif1/Fe" | datameanrichnull$Compasite == "recif1/Bi" | datameanrichnull$Compasite == "recif2/Bu" | datameanrichnull$Compasite == "recif2/Bi" | datameanrichnull$Compasite == "recif2/Fe" | datameanrichnull$Compasite == "recif3/Bi" | datameanrichnull$Compasite == "recif3/Bu" | datameanrichnull$Compasite == "recif3/Fe" | datameanrichnull$Compasite == "Bi/recif1" | datameanrichnull$Compasite == "Bi/recif2" | datameanrichnull$Compasite == "Bi/recif3" | datameanrichnull$Compasite == "Bu/recif1" | datameanrichnull$Compasite == "Bu/recif2" | datameanrichnull$Compasite == "Bu/recif3" | datameanrichnull$Compasite == "Fe/recif1" | datameanrichnull$Compasite == "Fe/recif2" | datameanrichnull$Compasite == "Fe/recif3" | datameanrichnull$Compasite == "VB/recif1" | datameanrichnull$Compasite == "VB/recif2" | datameanrichnull$Compasite == "VB/recif3"   | datameanrichnull$Compasite == "VB/recif3" | datameanrichnull$Compasite == "VB/recif3" | datameanrichnull$Compasite == "recif2/recif1"| datameanrichnull$Compasite == "recif3/recif2"| datameanrichnull$Compasite == "recif3/recif1"]<-"Intersite"

datameanrichnull$Compa[datameanrichnull$Compasite == "Bi/Bi"| datameanrichnull$Compasite == "Bu/Bu"| datameanrichnull$Compasite == "Fe/Fe"| datameanrichnull$Compasite == "VB/VB"|datameanrichnull$Compasite == "recif1/recif1"|datameanrichnull$Compasite == "recif2/recif2"|datameanrichnull$Compasite == "recif3/recif3"] <- "Intra"


datameanrichnull$Compa[datameanrichnull$Compa == "Intersite" & datameanrichnull$Compastruct == "Colonnes/Colonnes" |datameanrichnull$Compa == "Intersite" & datameanrichnull$Compastruct == "Disques/Disques" |datameanrichnull$Compa == "Intersite" & datameanrichnull$Compastruct == "Piliers/Piliers" |datameanrichnull$Compa == "Intersite" & datameanrichnull$Compastruct == "Failles/Failles"]<-"Intersite 2"


# structure
datameanrichnull$Compa[datameanrichnull$Compastruct == "Colonnes/Disques" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Colonnes/Failles" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Disques/Colonnes" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Disques/Failles" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Disques/Piliers" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Failles/Colonnes" & datameanrichnull$Compa =="Intra" | datameanrichnull$Compastruct == "Failles/Disques" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Failles/Piliers"  & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Piliers/Colonnes" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Piliers/Disques" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Piliers/Failles"  & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Colonnes/Piliers" & datameanrichnull$Compa =="Intra"] <- "Interstruct"


datameanrichnull$Compa[datameanrichnull$Compastruct == "Disques/Disques" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Failles/Failles" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Colonnes/Colonnes" & datameanrichnull$Compa =="Intra"| datameanrichnull$Compastruct == "Piliers/Piliers" & datameanrichnull$Compa =="Intra"] <- "Intrastruct"

# baie
datameanrichnull$Compa[datameanrichnull$Compasite == "Bi/recif1" | datameanrichnull$Compasite == "Bi/recif2" | datameanrichnull$Compasite == "Bi/recif3" | datameanrichnull$Compasite == "Bu/recif1" | datameanrichnull$Compasite == "Bu/recif2" | datameanrichnull$Compasite == "Bu/recif3" | datameanrichnull$Compasite == "Fe/recif1" | datameanrichnull$Compasite == "Fe/recif2" | datameanrichnull$Compasite == "Fe/recif3" | datameanrichnull$Compasite == "VB/recif1" | datameanrichnull$Compasite == "VB/recif2" | datameanrichnull$Compasite == "VB/recif3"   | datameanrichnull$Compasite == "VB/recif3" | datameanrichnull$Compasite == "VB/recif3"| datameanrichnull$Compasite == "recif1/Bu" | datameanrichnull$Compasite == "recif1/Fe" | datameanrichnull$Compasite == "recif1/Bi" | datameanrichnull$Compasite == "recif2/Bu" | datameanrichnull$Compasite == "recif2/Bi" | datameanrichnull$Compasite == "recif2/Fe" | datameanrichnull$Compasite == "recif3/Bi" | datameanrichnull$Compasite == "recif3/Bu" | datameanrichnull$Compasite == "recif3/Fe"]<-"Interbaie"

datameanrichnull$Compa[datameanrichnull$Compa=="Interbaie" & datameanrichnull$Compastruct == "Colonnes/Colonnes" | datameanrichnull$Compa=="Interbaie" & datameanrichnull$Compastruct == "Disques/Disques" | datameanrichnull$Compa=="Interbaie" & datameanrichnull$Compastruct == "Piliers/Piliers"| datameanrichnull$Compa=="Interbaie" & datameanrichnull$Compastruct == "Failles/Failles"]<-"Interbaie 2"


datameanrichnull = datameanrichnull %>% filter(!Compa == "Intersite") %>% filter(!Compa == "Interbaie")


datameanrichnull$Compasite2<-datameanrichnull$Compasite
datameanrichnull$Compasite2[datameanrichnull$Compasite=="recif1/recif2"| datameanrichnull$Compasite=="recif1/recif3"  | datameanrichnull$Compasite=="recif2/recif3" | datameanrichnull$Compasite=="recif3/recif2"| datameanrichnull$Compasite=="recif3/recif1"| datameanrichnull$Compasite=="recif2/recif1"]<-"goelo"


datameanrichnull2<-aggregate(BIvalue~BIindex+Compastruct+Comp_date+Compa+Compasite2,data=datameanrichnull[datameanrichnull$Compasite2=="goelo",],FUN=mean)
datameanrichnull3<-aggregate(BIvalue~BIindex+Compastruct+Comp_date+Compa+Compasite2,data=datameanrichnull[datameanrichnull$Compasite2!="goelo",],FUN=mean)

datameanrichnull4<-rbind(datameanrichnull2,datameanrichnull3)




### regroupement des jeux de données
# databetaindex2 <- cbind(datameansiminull[,-1],datameanrempnull[,-c(1:5,7)],datameanrichnull[,-c(1:5,7)])

databetaindex2 <- cbind(datameansiminull4[,-1],datameanrempnull4[,-c(1:5)],datameanrichnull4[,-c(1:5)])
# databetaindex2<-databetaindex2[,c(1:3,4,6,5,7,8)]
colnames(databetaindex2)[5:7]<-c("Similarité","Remplacement","Richesse")
...
#enlève les lignes avec goelo en inter site
# datameansiminull4<-datameansiminull4[which(datameansimi4$Compa!="Intersite" & datameansimi4$Compasite2 !="goelo"),]
# datameanrempnull4<-datameanrempnull4[which(datameanrempnull4$Compa!="Intersite" & datameanrempnull4$Compasite2 !="goelo"),]
# datameanrichnull4<-datameanrichnull4[which(datameanrichnull4$Compa!="Intersite" & datameanrichnull4$Compasite2 !="goelo"),]
```
...
## Betadéviation
```{r}
######### Soustraction données modell null-données réelles

# datameansimi4$Comp_date<-fct_relevel(datameansimi4$Comp_date,levels(as.factor(datameansimi4$Comp_date)))
datameansimi4=datameansimi4 %>% select(-Compasaison)
datameansimi4<-datameansimi4[,c(2,3,4,5,6,1)]

datameansiminull5 = datameansiminull %>% ungroup() %>%  select(Compastruct,Comp_date,Compa,Compasite2,BIvalue,BIindex)
datameansiminull5complet <- merge(datameansimi4, datameansiminull, by = c("Compastruct","Comp_date","Compa","Compasite2"))

colnames(datameansiminull5complet)[c(5,9)]<-c("valuereelle","valuenull")
datameansiminull5complet$valuediff<-datameansiminull5complet$valuereelle-datameansiminull5complet$valuenull

datameansimicomplet<-datameansiminull5complet



datameanremp4=datameanremp4 %>% select(-Compasaison)
datameanremp4<-datameanremp4[,c(2,3,4,5,6,1)]

datameanrempnull5 = datameanrempnull %>% ungroup() %>%  select(Compastruct,Comp_date,Compa,Compasite2,BIvalue,BIindex)
datameanrempnull5complet <- merge(datameanremp4, datameanrempnull, by = c("Compastruct","Comp_date","Compa","Compasite2"))

colnames(datameanrempnull5complet)[c(5,9)]<-c("valuereelle","valuenull")
datameanrempnull5complet$valuediff<-datameanrempnull5complet$valuereelle-datameanrempnull5complet$valuenull

datameanrempcomplet<-datameanrempnull5complet




datameanrich4=datameanrich4 %>% select(-Compasaison)
datameanrich4<-datameanrich4[,c(2,3,4,5,6,1)]

datameanrichnull5 = datameanrichnull %>% ungroup() %>%  select(Compastruct,Comp_date,Compa,Compasite2,BIvalue,BIindex)
datameanrichnull5complet <- merge(datameanrich4, datameanrichnull, by = c("Compastruct","Comp_date","Compa","Compasite2"))

colnames(datameanrichnull5complet)[c(5,9)]<-c("valuereelle","valuenull")
datameanrichnull5complet$valuediff<-datameanrichnull5complet$valuereelle-datameanrichnull5complet$valuenull
datameanrichcomplet<-datameanrichnull5complet
...
ggplot(datameansimicomplet, aes(x=Compa, y=valuediff))+
  geom_violin(aes(fct_reorder(Compa,-valuediff),fill=Compa),trim=FALSE)+
  geom_boxplot(width=0.2,aes(fill=Compa))+
  # scale_color_manual(values = c("gray77", "gray63", "gray40","gray8"))+
  theme_bw()+
  xlab("Echelle")+ ylab("Similarité")+
  ...
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de similarité")
ggsave("Similarité Betadeviation avec sign.png",width=8,height=8,dpi=350)


compar<-list(c("Interbaie 2","Intersite 2"),c("Interstruct","Interbaie 2"),c("Interstruct","Intrastruct"),c("Intrastruct","Interbaie 2"),c("Interstruct","Intersite 2"),c("Intrastruct","Intersite 2"))

ggplot(datameanrempcomplet, aes(x=Compa, y=valuediff))+
  geom_violin(aes(fct_reorder(Compa,-valuediff),fill=Compa))+
  geom_boxplot(width=0.2,aes(fill=Compa))+
  # scale_color_manual(values = c("gray77", "gray63", "gray40","gray8"))+
  theme_bw()+
  xlab("Echelle")+ ylab("Remplacement")+
  ...
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de remplacement")
ggsave("Remplacement Betadeviation avec sign.png",width=8,height=8,dpi=350)


compar<-list(c("Interstruct","Interbaie 2"),c("Interstruct","Intersite 2"),c("Intrastruct","Intersite 2"),c("Interstruct","Intrastruct"),c("Interbaie 2","Intersite 2"),c("Intrastruct","Interbaie 2"))

ggplot(datameanrichcomplet, aes(x=Compa, y=valuediff))+
  geom_violin(aes(fct_reorder(Compa,-valuediff),fill=Compa))+
  geom_boxplot(width=0.2,aes(fill=Compa))+
  # scale_color_manual(values = c("gray77", "gray63", "gray40","gray8"))+
  theme_bw()+
  ...
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de richesse")
ggsave("Richesse Betadeviation avec sign.png",width=8,height=8,dpi=350)





ggplot(datameansimicomplet, aes(x=c("valuerelle"), y=valuereelle))+
  # geom_violin(aes(fct_reorder(Compa,-valuereelle),fill=Compa))+
  geom_boxplot(width=0.2,aes(fill="green"))+
  # geom_violin(aes(fct_reorder(Compa,-valuenull),fill=Compa))+
  geom_boxplot(width=0.2,aes(x=c("valuenull"),valuenull,fill="blue"))+
  # scale_color_manual(values = c("gray77", "gray63", "gray40","gray8"))+
  theme_bw()+
  theme(legend.position="none")+
  # geom_signif(comparisons=compar,map_signif_level = TRUE,step_increase = 0.05,textsize = 8,vjust=0.5)+
  ...
  theme(axis.title.y = element_text(size=16,colour="black"))+
  xlab("Echelle de comparaisons")+ylab("Valeurs de richesse")
  # labs(title = "bleu = valeurs réelles rouge = valeurs null")
ggsave("intersite.png",width=8,height=8,dpi=350)
