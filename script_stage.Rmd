...
ggradar(resultat4Bi[,-2],grid.min = 1,grid.max =15,values.radar = c(0,7, 15),group.colours = "blue",legend.title="Site")
...
ggradar(resultat4Bu[,-2],grid.min = 1,grid.max =15,values.radar = c(0,7, 15),group.colours = "red",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
...
ggradar(resultat4Fe[,-2],grid.min = 1,grid.max =15,values.radar = c(0,7, 15),group.colours = "red",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
...
ggradar(resultat4VB[,-2],grid.min = 1,grid.max =15,values.radar = c(0,7, 15),group.colours = "red",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
...
ggradar(resultat3Bi[,-2],grid.min = 1,grid.max =10,grid.mid=5,values.radar = c(0,10,20),group.colours = "blue",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
...
ggradar(resultat3Bu[,-2],grid.min = 1,grid.max =10,grid.mid=5,values.radar = c(0,10,20),group.colours = "red",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
...
ggradar(resultat3Fe[,-2],grid.min = 1,grid.max =10,grid.mid=5,values.radar = c(0,10,20),group.colours = "green",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
...
ggradar(resultat3VB[,-2],grid.min = 1,grid.max =10,grid.mid=5,values.radar = c(0,10,20),group.colours = "orange",legend.title="Site",gridline.max.linetype = 1,gridline.max.colour = "black",background.circle.colour = "lightblue")
