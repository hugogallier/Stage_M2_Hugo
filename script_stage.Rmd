...
ggplot(PCOA_df, aes(x = x, y = y,colour = paste(Site,Date,sep="_"))) +
  ...
  labs(color="Sites et dates")+ theme_bw() 
...
datatern2=datatern %>%
  ...
  # filter(!Date1 %in% c("2021-04","2021-07",'2021-11')) %>%
    # filter(!Date2 %in% c("2021-04","2021-07",'2021-11')) %>%
...
datamean<-datatern2 %>%  group_by(Comp_site,Compastruct,Compadate,Compasaison) %>%  #permet de faire la moyenne de chaque colonne par site/struct
...
ggtern(data=datatern2, aes(x=Richesse,y=Similarité,z=Remplacement)) +
  # geom_point(aes(colour=Compasite), position=position_jitter_tern(x=0.1, y=0.1, z=0.1),alpha=.3) +
    # geom_point(aes(colour=Compastruct), position=position_jitter_tern(x=0.1, y=0.1, z=0.1),alpha=.3) +
      geom_point(aes(colour=Compasaison), position=position_jitter_tern(x=0.1, y=0.1, z=0.1),alpha=.3) +
