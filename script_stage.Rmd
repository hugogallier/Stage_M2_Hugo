...
s.class(PCOA_df[c(1:2)],as.factor(PCOA_df$Site),col=c("#fb746b","#7cab04","#00bfc4","#c77cff"),ellipseSize=0) # permet de faire le graph de l'PCoA avec des barycentres
...
ggplot(data_comp3,aes(x=Structure2,y=Mcov3,fill=spp))+
  geom_col()
