...
ggplot(dataR3, aes(Structure2,S2,fill=Structure2))+ 
...
ggplot(PCOA_df, aes(x = x, y = y,colour =Date )) +
  ...
  #   label.padding = unit(0.25, "lines"), # Rectangle size around label
  #   label.size = 0.35,color = "darkgrey",fill="white")+
  # geom_label(
  ...
  geom_label(
    ...
    label.padding = unit(0.25, "lines"), 
    # label.size = 0.35,color = "lightblue",fill="white")+
  ...
  geom_label(
    ...
    label.padding = unit(0.25, "lines"), 
    # label.size = 0.35,color = "darkgreen",fill="white")+
      label.size = 0.35,color = "yellow",fill="white")+
...
geom_label(
    ...
    label.padding = unit(0.25, "lines"), 
    # label.size = 0.35,color = "blue",fill="white")+
      label.size = 0.35,color = "lightblue",fill="white")+

  geom_label(
    label="2022-07", x=barycenters$x[which(barycenters$Date=="2022-07")], y=barycenters$y[which(barycenters$Date=="2022-07")],
    label.padding = unit(0.25, "lines"), 
    # label.size = 0.35,color = "brown",fill="white")+
      label.size = 0.35,color = "darkblue",fill="white")+
...
ggplot(PCOA_df, aes(x = x, y = y,colour =Site )) +
  geom_point(alpha=.2) +
     # Ajouter les barycentres
  geom_point(data = barycenters, aes(x = x, y = y, colour = Site,shape=Date), size = 3) + #shape= forme selon la variable
     # Ajout lignes entre les barycentres et les points
...
ggplot(PCOA_df, aes(x = x, y = y,colour = Site)) +
  ...
  geom_point(data = barycenters, aes(x = x, y = y, colour = Site,shape=Date), size = 3) +
    # Ajout lignes entre les barycentres et les points
  ...
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Disc"),],aes(x=x[1],y=y[1],xend=x[2],yend=y[2]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Disc"),],aes(x=x[2],y=y[2],xend=x[3],yend=y[3]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Disc"),],aes(x=x[3],y=y[3],xend=x[4],yend=y[4]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Disc"),],aes(x=x[4],y=y[4],xend=x[5],yend=y[5]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Disc"),],aes(x=x[5],y=y[5],xend=x[6],yend=y[6]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
...
ggplot(PCOA_df, aes(x = x, y = y,colour = Site)) +
  ...
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Columns"),],aes(x=x[1],y=y[1],xend=x[2],yend=y[2]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Columns"),],aes(x=x[2],y=y[2],xend=x[3],yend=y[3]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Columns"),],aes(x=x[3],y=y[3],xend=x[4],yend=y[4]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Columns"),],aes(x=x[4],y=y[4],xend=x[5],yend=y[5]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Columns"),],aes(x=x[5],y=y[5],xend=x[6],yend=y[6]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
...
ggplot(PCOA_df, aes(x = x, y = y,colour = Site)) +
  ...
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Pillars"),],aes(x=x[1],y=y[1],xend=x[2],yend=y[2]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Pillars"),],aes(x=x[2],y=y[2],xend=x[3],yend=y[3]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Pillars"),],aes(x=x[3],y=y[3],xend=x[4],yend=y[4]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Pillars"),],aes(x=x[4],y=y[4],xend=x[5],yend=y[5]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Pillars"),],aes(x=x[5],y=y[5],xend=x[6],yend=y[6]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
...
ggplot(PCOA_df, aes(x = x, y = y,colour = Site)) +
  ...
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Inner_slots"),],aes(x=x[1],y=y[1],xend=x[2],yend=y[2]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Inner_slots"),],aes(x=x[2],y=y[2],xend=x[3],yend=y[3]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Inner_slots"),],aes(x=x[3],y=y[3],xend=x[4],yend=y[4]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Inner_slots"),],aes(x=x[4],y=y[4],xend=x[5],yend=y[5]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
  geom_segment(data = barycenters[which(barycenters$Site=="Fe" & barycenters$Structure=="Inner_slots"),],aes(x=x[5],y=y[5],xend=x[6],yend=y[6]),color="blue",arrow=arrow(type="closed",length=unit(0.07,"inches"),ends="last"))+
...
ggplot(PCOA_df, aes(x = x, y = y)) +
  geom_point(colour="black",alpha=.2)+
  geom_point(data=spp.scrs3,mapping=aes(x=Dim1,y=Dim2,colour=Abb),size=2)+
  geom_label_repel(data=spp.scrs3,mapping=aes(x=Dim1,y=Dim2,label=Abb,colour=Abb), position=position_stacknudge(x = .2, y=.1,vjust=.1),size=3,force_pull=5,force=100)+
    labs(color="Taxons significatifs")+ labs(x="Axe 1 (22,1%)",y="Axe 2 (12,1%)")+
  theme_bw() + 
  theme(legend.position="none") #enlève la légende
...
sDLCo=sDL %>%  select(Trajectory)
sDLDi=sDL %>%  select(Trajectory)
sDLPi=sDL %>%  select(Trajectory)
sDLF=sDL %>%  select(Trajectory)
sDlength<-rbind(sDLCo,sDLDi,sDLPi,sDLF)
sDlength$Structure<-rep(c("Colonnes","Disques","Piliers","Faille"),each=4)
...
aov1<-aov(Trajectory~Structure+Site,data=sDlength)
summary(aov1)
...
##### Essayer de diviser les longeurs à chaque poitn par le temps pour avoir la vitesse
...
sDACo=sDA %>%  select(-rho)%>% mutate("S5-S6"=="0") 
colnames(sDACo)[7]<-"S5-S6"
sDACo<-sDACo[,c(1:4,7,5:6)] 
sDADi=sDA %>%  select(-rho)
sDAPi=sDA %>%  select(-rho) %>% mutate("S5-S6"=="0") 
colnames(sDAPi)[7]<-"S5-S6"
sDAPi<-sDAPi[,c(1:4,7,5:6)]
sDAF=sDA  %>%  select(-rho)

sDAngle<-rbind(sDACo,sDADi,sDAPi,sDAF)
sDAngle$Structure<-rep(c("Colonnes","Disques","Piliers","Faille"),each=4)
sDAngle$Site<-c("Bi","Bu","Fe","VB")
sDAngle$sd<-sqrt(sDAngle$mean)

colnames(sDAngle)[c(1:5)]<-c("premier","deuxieme","troisieme","quatrieme","cinquieme")



ggplot(sDAngle[-c(3,7,11,15),], aes(Structure,premier,colour=Site))+ 
  geom_point(stat="identity",alpha=.7)+
  theme_bw()+ 
  xlab("")+ylab("Angles des vecteurs entre avril et juillet 2021") # pas sûr des dates parce que possible que les structures n'ont pas été échantillonnées tout le temps

ggplot(sDAngle[-c(3,7,11,15),], aes(Structure,deuxieme,colour=Site))+ 
  geom_point(stat="identity",alpha=.7)+
  theme_bw()+ 
  xlab("")+ylab("Angles des vecteurs entre juillet et novembre 2021")# pas sûr des dates parce que possible que les structures n'ont pas été échantillonnées tout le temps

ggplot(sDAngle[-c(3,7,11,15),], aes(Structure,troisieme,colour=Site))+ 
  geom_point(stat="identity",alpha=.7)+
  theme_bw()+ 
  xlab("")+ylab("Angles des vecteurs entre novembre et janvier 2021")# pas sûr des dates parce que possible que les structures n'ont pas été échantillonnées tout le temps

ggplot(sDAngle[-c(3,7,11,15),], aes(Structure,quatrieme,colour=Site))+ 
  geom_point(stat="identity",alpha=.7)+
  theme_bw()+ 
  xlab("")+ylab("Angles des vecteurs entre janvier et avril 2021")# pas sûr des dates parce que possible que les structures n'ont pas été échantillonnées tout le temps


ggplot(sDAngle, aes(Structure,mean,fill=Site))+ 
  geom_bar(stat="identity",alpha=.7)+
  # geom_boxplot()+
...
ggplot(sDDirection, aes(Structure,value,fill=Structure))+ 
  geom_bar(stat="identity",alpha=.7)+
  # geom_boxplot()+
  geom_errorbar(aes(ymin=value, ymax=value+sd), width=.2, position=position_dodge(.9))+ #ajout des barres d'erreur
  theme_bw()+ 
...
#les données ne sont pas significatives donc pas pris en compte
```
...
datamean<-datatern2 %>%  group_by(Comp_site,Compasite,Compastruct,Comp_struct) %>%  #permet de faire la moyenne de chaque colonne par site/struct
...
ggtern(data=datatern2, aes(x=Richesse,y=Similarité,z=Remplacement,group=Compastruct)) +
  ...
  geom_point(aes(color=Compastruct),position=position_jitter_tern(x=0.1, y=0.1, z=0.1),alpha=.1)+
        geom_point(data=datamean,aes(color=Compastruct)) +
...
## Calcul de beta et comparaison intersite ou interstructures
```{r}
...
datamean<-datatern2 %>%  group_by(Compasite,Compastruct,Comp_date,Comp_day) %>% 
  dplyr::summarize(Similarité=mean(Similarité),
            Remplacement=mean(Remplacement),
            Richesse=mean(Richesse))


datameansimi=datamean %>% select(Compasite,Compastruct,Comp_date,Comp_day,Similarité) %>% 
  mutate(Betaindex= "Similarité") %>% select(Betaindex,Compasite,Compastruct,Comp_date,Comp_day,Similarité)
colnames(datameansimi)[6]<-"BIvalue"

datameanremp=datamean %>% select(Compasite,Compastruct,Comp_date,Comp_day,Remplacement) %>% 
  mutate(Betaindex= "Remplacement") %>% select(Betaindex,Compasite,Compastruct,Comp_date,Comp_day,Remplacement)
colnames(datameanremp)[6]<-"BIvalue"

datameanrich=datamean %>% select(Compasite,Compastruct,Comp_date,Comp_day,Richesse)  %>% 
  mutate(Betaindex= "Richesse") %>% select(Betaindex,Compasite,Compastruct,Comp_date,Comp_day,Richesse)
...
model1<-gam(BIvalue~s(Comp_day)+s(Compastruct,bs="re")+s(Compasite,bs="re")+s(Betaindex,bs="re"),data=databetaindex) 
summary(model1)


plot_smooths(model=model1, series=Comp_day,comparison=Betaindex)+theme_bw()

ggplot(databetaindex,aes(x=Comp_day,y=BIvalue,colour=Betaindex))+
  geom_point()
...
datameansimi$Compastruct[datameansimi$Compastruct == "Columns/Disc"| datameansimi$Compastruct == "Columns/Iner_slots"| datameansimi$Compastruct == "Disc/Columns"| datameansimi$Compastruct == "Disc/Inner_slots"| datameansimi$Compastruct == "Disc/Pillars"| datameansimi$Compastruct == "Inner_slots/Columns" | datameansimi$Compastruct == "Inner_slots/Disc"| datameansimi$Compastruct == "Inner_slots/Pillars" | datameansimi$Compastruct == "Pillars/Columns"| datameansimi$Compastruct == "Pillars/Disc"| datameansimi$Compastruct == "Pillars/Inner_slots"] <- "Inter"
...
datameanrich$Compastruct[datameanrich$Compastruct == "Columns/Disc"| datameanrich$Compastruct == "Columns/Iner_slots"| datameanrich$Compastruct == "Disc/Columns"| datameanrich$Compastruct == "Disc/Inner_slots"| datameanrich$Compastruct == "Disc/Pillars"| datameanrich$Compastruct == "Inner_slots/Columns" | datameanrich$Compastruct == "Inner_slots/Disc"| datameanrich$Compastruct == "Inner_slots/Pillars" | datameanrich$Compastruct == "Pillars/Columns"| datameanrich$Compastruct == "Pillars/Disc"| datameanrich$Compastruct == "Pillars/Inner_slots"] <- "Inter"


databetaindex2 <- cbind(datameansimi[,-1],datameanremp[,-c(1:5)],datameanrich[,-c(1:5)])
colnames(databetaindex2)[5:7]<-c("Similarité","Remplacement","Richesse")



# random forest avec test plot selon variable
library(randomForest)
library(randomForestSRC)

rf1<-randomForest(BIvalue~.,data=datameansimi[,-c(1,5)],ntree=200)
rf2<-randomForest(BIvalue~.,data=datameanremp[,-c(1,5)],ntree=200)
rf3<-randomForest(BIvalue~.,data=datameanrich[,-c(1,5)],ntree=200)

rf4 <- rfsrc(as.numeric(BIvalue) ~ ., data=datameansimi[,-c(1,5)])

par(mfrow=c(2,2))
varImpPlot(rf1,main="Similarité")
varImpPlot(rf2,main="Remplacement")
varImpPlot(rf3,main="Richesse")
importance(rf1)


datameanrich$Compasite<-as.factor(datameanrich$Compasite)
datameanrich$Compastruct<-as.factor(datameanrich$Compastruct)
datameanrich$Comp_date<-as.factor(datameanrich$Comp_date)
datameanrich$BIvalue<-as.numeric(datameanrich$BIvalue)

datameansimi$Compasite<-as.factor(datameansimi$Compasite)
datameansimi$Compastruct<-as.factor(datameansimi$Compastruct)
datameansimi$Comp_date<-as.factor(datameansimi$Comp_date)
datameansimi$BIvalue<-as.numeric(datameansimi$BIvalue)

datameanrich2<-datameanrich[,-c(1,5)]



v.obj <- rfsrc(BIvalue~.,data= as.data.frame(datameanrich2))
     
## get partial effect of age on mortality
partial.obj <- partial(v.obj,
       partial.type = "mort",
       partial.xvar = "Compasite",
       partial.values = v.obj$xvar$Compasite,
       partial.time = v.obj$xvar$Comp_date)
...
partialPlot(rf1,datameansimi[,-c(1,5)],Compasite)

partial.obj <- partial(rf1,
                 partial.xvar = "Wind",
                 partial.values = airq.obj$xvar$Wind)

--> faire plot de dépendance partiel (package partial dependence plot)
```
...
#   annotate("rect",xmin=571,xmax=663.9,ymin=0,ymax=10,alpha=.1,fill="orange")+
#   annotate("rect",xmin=664,xmax=750,ymin=0,ymax=10,alpha=.1,fill="brown")+
annotate("text",x = c(65,159,252,344,433,524,617,708),y=5,
           label=c("Hiver","Printemps","Eté","Automne","Hiver","Printemps","Eté","Automne"),
           colour=c("#666666","#666666","#666666","#666666","#666666","#666666","#666666","#666666"))+
   xlab("Nombre de jours d'immersion")+
...
ggplot(data_comp31Bu,aes(x = 0,y=Mcov3,fill=forcats::fct_inorder(spp)))+
  ...
  geom_label_repel(aes(label =paste(spp,":",format(Mcov3,digits=1),"%")), position=position_stacknudge(x = .9, y=.2,vjust=.5),size=5,force=25)+
  theme_void()+
  theme(legend.position="none") 
