...
# Comparaison intrasite
```{r}
#Permet de montrer le nombre de taxon en fonction des sites, microhabitats et dates
dataR2=dataR %>% filter(!spp =="NI") %>% 
  group_by(Site,Micro,Date_courte) %>% 
  summarize(S=n())
