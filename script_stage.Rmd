...
model111111111<-gam(Mcov3~s(Day_delta)+s(Structure2,bs='re')+s(Site,bs="re")+s(saison,bs="re"),data=dataR4)
summary(model111111)
...
plot(model111111111,shift=mean(dataR4$Mcov3),residuals=T,cex=0.7,pch=16,col="blue",shade=T,shade.col='grey')
...
plot(summaryPCOA$PCTVAR[1:30],ylim=c(0,30),
