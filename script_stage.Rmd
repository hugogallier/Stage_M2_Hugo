...
# il s'agit du jeu de données de l'exemple du package
#pour la partie incidence
# C'était simplement pour m'en inspirer
data(ciliates)
ciliates$EtoshaPan


# On réorganise le df de base
# Ne pas oublié de virer les "None"
# Je rajoute une variable qui combine la date et la structure
...
comp_list_clean=lapply(LL, fun_clean)
...
# Il va maintenant plotter ça en intégrant les lower et upper confident interval ... A toi de jouer!
