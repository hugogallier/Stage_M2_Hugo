...
#   group_by(spp,Structure2,Day_delta,saison,Years)
#   summarize(Mcov2= mean(Mcov2,.by=c(spp,Structure2,Day_delta)))
...
sD<-trajectoryLengths(distdataR,data_comp2$Site,surveys=NULL)
