...
##### Convergence
sDAngle1=sDAngle %>% filter(!Site=="Fe")
distdataR1<-vegdist(sDAngle1[,c(1:4)], method='bray') 

sDD<-trajectoryConvergence(distdataR,sDAngle$Site,surveys=NULL) #convergence des vecteurs
